...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-10-2023 a las 00:16:41
...
INSERT INTO `compiten` (`idcompetidor`, `idTorneo`, `puesto`) VALUES
(1, 1, 1),
(2, 1, 3);
...
INSERT INTO `torneo` (`idTorneo`, `ubicacion`, `fecha`, `hora`) VALUES
(1, 'san gomes', '1001-11-11', '20:00:00'),
(2, ' gomes', '1001-12-11', '21:00:00');
...
--
-- Volcado de datos para la tabla `torneo_grupal`
--

INSERT INTO `torneo_grupal` (`idTorneo`) VALUES
(1);
...
--
-- Volcado de datos para la tabla `torneo_individual`
--

INSERT INTO `torneo_individual` (`idTorneo`, `categoria`) VALUES
(1, '');
