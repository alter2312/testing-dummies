...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-10-2023 a las 02:44:29
...
(2, 55499743, 'Pep2', 'Josef2', '2005-12-12', 'Femenino', 2),
(3, 55499739, 'Pepepina', 'Josefina', '2003-11-11', 'Masculino', 1);
...
INSERT INTO `compiten` (`idcompetidor`, `idTorneo`, `puesto`, `Categoria`, `NumKata`) VALUES
(1, 3, 1, '16/17', 1),
(2, 3, 3, '12/13', 1);
...
(1, '1002-11-11', '2023-11-01', '20:20:00', '22:22:00', 1),
(2, '1002-11-11', '2023-11-02', '21:20:00', '23:22:00', 2);
...
(3, 'san peron', '2023-10-18', '20:00:00', 'Masculino');
...
ALTER TABLE `compiten`
  ...
  ADD CONSTRAINT `compiten_ibfk_3` FOREIGN KEY (`NumKata`) REFERENCES `kata` (`NumKata`);
