    ...
    <main class="container">
        ...
        <div class="box-form">
            ...
            <div class="form-group">
                    <input type="text" class="input-form" id="CI" name="CI" pattern="[0-9]{8}" title="Tu cedula deben ser los 8 dígitos sin la barra" required />
...
<div class="box-form box-form-right">
                    <div class="form-group">
                        <input type="text" class="input-form" id="CI" name="CI-coach" pattern="[0-9]{8}" title="Tu cedula deben ser los 8 dígitos sin la barra" required />
                        <label for="CI" class="label-form">CI</label>
                    </div>

                    <div class="form-group">
                        <input type="text" class="input-form" id="nombre" name="nombre-coach" pattern="[A-Za-zÁ-ú\s]{1,30}" required />
                        <label for = "nombre" class="label-form">Nombre</label>
                    </div>

                    <div class="form-group">
                        <input type="text" class="input-form" id="apellido" name="apellido-coach" pattern="[A-Za-zÁ-ú\s]{1,30}" required/>
                        <label for="" class="label-form">Apellido</label>
                    </div>
                    <div class="form-group">
                        <input type="text" class="input-form" id="telefono" name="telefono-coach" pattern="[0-9]{9}" required/>
