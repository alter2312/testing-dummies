...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-10-2023 a las 22:24:17
...
INSERT INTO `competidor` (`idcompetidor`, `CI`, `nombre`, `apellido`, `fecha_nac`, `genero`) VALUES
(1, 55499749, 'Pepe', 'Josefodddd', '2005-11-11', 'Masculino'),
(2, 12345678, 'Pep', 'JosE', '2005-12-12', 'Masculino'),
(14, 12345643, 'asd', 'asd', '1231-03-12', 'Femenino'),
(15, 12312321, 'asd', 'sad', '3123-12-23', 'Masculino');
...
CREATE TABLE `compiten` (
  ...
  `Categoria` enum('12/13','14/15','16/17','Mayores') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
CREATE TABLE `usuario` (
  ...
  `grupoUsuario` enum('Juez','Administrador','AdministradorBDKarate','Juez1') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
(6, 'Juez6', 'Juez', 'Juez'),
(7, 'Juez7', 'Juez', 'Juez'),
(8, 'Administrador', 'admin', 'Administrador'),
(9, 'Administrador', 'root', 'AdministradorBDKarate');
...
--
ALTER TABLE `competidor`
  MODIFY `idcompetidor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `dojo`
--
ALTER TABLE `dojo`
  MODIFY `idDojo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
